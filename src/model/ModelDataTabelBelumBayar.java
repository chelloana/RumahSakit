 ...
 * @author ACER
 */
public class ModelDataTabelBelumBayar extends AbstractTableModel{
        List<datapembayaran> dp;
    
        
    public ModelDataTabelBelumBayar(List<datapembayaran>dp){
        this.dp = dp;
    }
    ...
    public Object getValueAt(int row, int column) {
        switch(column){
            ...
            case 7:
                return dp.get(row).getJenis_tunjangan();
            default:
                return null;
        }
    }
